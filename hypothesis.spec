...
Source0  : https://files.pythonhosted.org/packages/4e/d5/8752554de6e1dca66487b2ac36c6d8727f5a5327089564d02ecbde4ec729/hypothesis-6.13.14.tar.gz
...
%prep
%setup -q -n hypothesis-6.13.14
cd %{_builddir}/hypothesis-6.13.14
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1622817465
...
cp %{_builddir}/hypothesis-6.13.14/LICENSE.txt %{buildroot}/usr/share/package-licenses/hypothesis/cbc4c246c44ed63fb158856a846c0962ae22668d
