...
Version  : 6.0.1
Release  : 477
URL      : https://files.pythonhosted.org/packages/19/d8/5f98479b971d9473d3f1e36d4b1bb57a1d554119173fa1ee3a2e24eb4555/hypothesis-6.0.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/19/d8/5f98479b971d9473d3f1e36d4b1bb57a1d554119173fa1ee3a2e24eb4555/hypothesis-6.0.1.tar.gz
...
%prep
%setup -q -n hypothesis-6.0.1
cd %{_builddir}/hypothesis-6.0.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1610554782
...
cp %{_builddir}/hypothesis-6.0.1/LICENSE.txt %{buildroot}/usr/share/package-licenses/hypothesis/cbc4c246c44ed63fb158856a846c0962ae22668d
