...
Source0  : https://files.pythonhosted.org/packages/7f/99/73c934586abb5966669bc2e90f5483bdb9f02918ca0b0693156b52297330/hypothesis-6.6.0.tar.gz
...
%prep
%setup -q -n hypothesis-6.6.0
cd %{_builddir}/hypothesis-6.6.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1615217472
...
cp %{_builddir}/hypothesis-6.6.0/LICENSE.txt %{buildroot}/usr/share/package-licenses/hypothesis/cbc4c246c44ed63fb158856a846c0962ae22668d
