...
Version  : 5.20.2
Release  : 426
URL      : https://files.pythonhosted.org/packages/a0/77/cd5cfed41ec83bafc79805ccf2a0c81a6abb7683006a95483ea5c8372d67/hypothesis-5.20.2.tar.gz
Source0  : https://files.pythonhosted.org/packages/a0/77/cd5cfed41ec83bafc79805ccf2a0c81a6abb7683006a95483ea5c8372d67/hypothesis-5.20.2.tar.gz
...
%prep
%setup -q -n hypothesis-5.20.2
cd %{_builddir}/hypothesis-5.20.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1595257029
...
cp %{_builddir}/hypothesis-5.20.2/LICENSE.txt %{buildroot}/usr/share/package-licenses/hypothesis/cbc4c246c44ed63fb158856a846c0962ae22668d
