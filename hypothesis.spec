...
Version  : 3.28.3
Release  : 54
URL      : http://pypi.debian.net/hypothesis/hypothesis-3.28.3.tar.gz
Source0  : http://pypi.debian.net/hypothesis/hypothesis-3.28.3.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1505740183
