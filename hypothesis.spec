...
Source0  : https://files.pythonhosted.org/packages/32/51/7c131b250a356a0a563eb8ef9b074b77d0f5ec30389ee0cc5193315137d3/hypothesis-5.37.3.tar.gz
...
%prep
%setup -q -n hypothesis-5.37.3
cd %{_builddir}/hypothesis-5.37.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1602772648
...
cp %{_builddir}/hypothesis-5.37.3/LICENSE.txt %{buildroot}/usr/share/package-licenses/hypothesis/cbc4c246c44ed63fb158856a846c0962ae22668d
