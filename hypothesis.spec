...
Version  : 3.8.5
Release  : 29
URL      : http://pypi.debian.net/hypothesis/hypothesis-3.8.5.tar.gz
Source0  : http://pypi.debian.net/hypothesis/hypothesis-3.8.5.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1495032818
