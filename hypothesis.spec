...
Source0  : https://files.pythonhosted.org/packages/fd/51/fe3868c4fc61b5a82a2074b0ebd26086ed9cd9ea5699ec385640256daf52/hypothesis-5.19.3.tar.gz
...
%prep
%setup -q -n hypothesis-5.19.3
cd %{_builddir}/hypothesis-5.19.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1594823745
...
cp %{_builddir}/hypothesis-5.19.3/LICENSE.txt %{buildroot}/usr/share/package-licenses/hypothesis/cbc4c246c44ed63fb158856a846c0962ae22668d
