...
Source0  : https://files.pythonhosted.org/packages/dd/50/d2d2840249aa01371da9a0d55c03f42989a6f28ae7f9bf9cf0eeeffef63b/hypothesis-5.41.3.tar.gz
...
%prep
%setup -q -n hypothesis-5.41.3
cd %{_builddir}/hypothesis-5.41.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1605715596
...
cp %{_builddir}/hypothesis-5.41.3/LICENSE.txt %{buildroot}/usr/share/package-licenses/hypothesis/cbc4c246c44ed63fb158856a846c0962ae22668d
