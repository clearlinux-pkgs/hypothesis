...
Version  : 3.9.1
Release  : 31
URL      : http://pypi.debian.net/hypothesis/hypothesis-3.9.1.tar.gz
Source0  : http://pypi.debian.net/hypothesis/hypothesis-3.9.1.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1495462098
