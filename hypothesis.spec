...
Version  : 4.44.5
Release  : 360
URL      : https://files.pythonhosted.org/packages/de/70/2fc996dfcce02a4e8e0a51c10217830e08772af2547266325fcf8e9f33f2/hypothesis-4.44.5.tar.gz
Source0  : https://files.pythonhosted.org/packages/de/70/2fc996dfcce02a4e8e0a51c10217830e08772af2547266325fcf8e9f33f2/hypothesis-4.44.5.tar.gz
...
%prep
%setup -q -n hypothesis-4.44.5
cd %{_builddir}/hypothesis-4.44.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1574294755
...
cp %{_builddir}/hypothesis-4.44.5/LICENSE.txt %{buildroot}/usr/share/package-licenses/hypothesis/cbc4c246c44ed63fb158856a846c0962ae22668d
