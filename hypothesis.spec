...
Source0  : https://files.pythonhosted.org/packages/13/13/1f3909df62388c302fac4bd69b2691fc0a52a2dfece8d234e7e519593b7e/hypothesis-6.24.2.tar.gz
...
%prep
%setup -q -n hypothesis-6.24.2
cd %{_builddir}/hypothesis-6.24.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1636131783
...
cp %{_builddir}/hypothesis-6.24.2/LICENSE.txt %{buildroot}/usr/share/package-licenses/hypothesis/cbc4c246c44ed63fb158856a846c0962ae22668d
