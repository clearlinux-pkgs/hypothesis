...
Version  : 5.35.3
Release  : 449
URL      : https://files.pythonhosted.org/packages/ba/b2/5a227ac4e0fa5c97c68652df20888a168502af54da4ddb13a2c562fca993/hypothesis-5.35.3.tar.gz
Source0  : https://files.pythonhosted.org/packages/ba/b2/5a227ac4e0fa5c97c68652df20888a168502af54da4ddb13a2c562fca993/hypothesis-5.35.3.tar.gz
...
%prep
%setup -q -n hypothesis-5.35.3
cd %{_builddir}/hypothesis-5.35.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1600192138
...
cp %{_builddir}/hypothesis-5.35.3/LICENSE.txt %{buildroot}/usr/share/package-licenses/hypothesis/cbc4c246c44ed63fb158856a846c0962ae22668d
