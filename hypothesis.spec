...
Source0  : https://files.pythonhosted.org/packages/59/5e/b12e12ce567ca4d1983d621cd8d49d7747785ea13bbf7de33ca34bcb438d/hypothesis-5.41.2.tar.gz
...
%prep
%setup -q -n hypothesis-5.41.2
cd %{_builddir}/hypothesis-5.41.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1604937256
...
cp %{_builddir}/hypothesis-5.41.2/LICENSE.txt %{buildroot}/usr/share/package-licenses/hypothesis/cbc4c246c44ed63fb158856a846c0962ae22668d
