...
Version  : 6.8.8
Release  : 500
URL      : https://files.pythonhosted.org/packages/5e/4a/e6959b7b1a0661e7ce997c8e785aa23f433c1bc52db6e2454446a79df7c4/hypothesis-6.8.8.tar.gz
Source0  : https://files.pythonhosted.org/packages/5e/4a/e6959b7b1a0661e7ce997c8e785aa23f433c1bc52db6e2454446a79df7c4/hypothesis-6.8.8.tar.gz
...
%prep
%setup -q -n hypothesis-6.8.8
cd %{_builddir}/hypothesis-6.8.8
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1617806137
...
cp %{_builddir}/hypothesis-6.8.8/LICENSE.txt %{buildroot}/usr/share/package-licenses/hypothesis/cbc4c246c44ed63fb158856a846c0962ae22668d
