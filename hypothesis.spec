...
Version  : 6.10.0
Release  : 504
URL      : https://files.pythonhosted.org/packages/21/da/2b1b7765b0aec4b1ad078f1043dc48726a49898901133952389d320de714/hypothesis-6.10.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/21/da/2b1b7765b0aec4b1ad078f1043dc48726a49898901133952389d320de714/hypothesis-6.10.0.tar.gz
...
%prep
%setup -q -n hypothesis-6.10.0
cd %{_builddir}/hypothesis-6.10.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1618777527
...
cp %{_builddir}/hypothesis-6.10.0/LICENSE.txt %{buildroot}/usr/share/package-licenses/hypothesis/cbc4c246c44ed63fb158856a846c0962ae22668d
