...
Version  : 6.0.3
Release  : 479
URL      : https://files.pythonhosted.org/packages/7a/af/651623c0a95f1e80612ae2ab8fddace2adbcf238e2050c97f1e24a554234/hypothesis-6.0.3.tar.gz
Source0  : https://files.pythonhosted.org/packages/7a/af/651623c0a95f1e80612ae2ab8fddace2adbcf238e2050c97f1e24a554234/hypothesis-6.0.3.tar.gz
...
%prep
%setup -q -n hypothesis-6.0.3
cd %{_builddir}/hypothesis-6.0.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1611426311
...
cp %{_builddir}/hypothesis-6.0.3/LICENSE.txt %{buildroot}/usr/share/package-licenses/hypothesis/cbc4c246c44ed63fb158856a846c0962ae22668d
