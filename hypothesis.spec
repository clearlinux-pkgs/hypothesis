...
Version  : 6.9.2
Release  : 503
URL      : https://files.pythonhosted.org/packages/9f/55/ca134a35ade2848ccb6a38038cbdc144c8d975ba9f8535f980233784f3a5/hypothesis-6.9.2.tar.gz
Source0  : https://files.pythonhosted.org/packages/9f/55/ca134a35ade2848ccb6a38038cbdc144c8d975ba9f8535f980233784f3a5/hypothesis-6.9.2.tar.gz
...
%prep
%setup -q -n hypothesis-6.9.2
cd %{_builddir}/hypothesis-6.9.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1618498463
...
cp %{_builddir}/hypothesis-6.9.2/LICENSE.txt %{buildroot}/usr/share/package-licenses/hypothesis/cbc4c246c44ed63fb158856a846c0962ae22668d
