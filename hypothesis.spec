...
Version  : 6.29.3
Release  : 566
URL      : https://files.pythonhosted.org/packages/0d/ff/85c51a30082945fbb78ae3dee62ac8311ae3f3a2ff71f89fbbf8917a5684/hypothesis-6.29.3.tar.gz
Source0  : https://files.pythonhosted.org/packages/0d/ff/85c51a30082945fbb78ae3dee62ac8311ae3f3a2ff71f89fbbf8917a5684/hypothesis-6.29.3.tar.gz
...
%prep
%setup -q -n hypothesis-6.29.3
cd %{_builddir}/hypothesis-6.29.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1638451600
...
cp %{_builddir}/hypothesis-6.29.3/LICENSE.txt %{buildroot}/usr/share/package-licenses/hypothesis/cbc4c246c44ed63fb158856a846c0962ae22668d
