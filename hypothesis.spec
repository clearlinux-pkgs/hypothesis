...
Version  : 5.36.1
Release  : 453
URL      : https://files.pythonhosted.org/packages/86/8a/c72bd4338761d1785a180250790db3f9e877fc37e84b46fafff56bbed080/hypothesis-5.36.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/86/8a/c72bd4338761d1785a180250790db3f9e877fc37e84b46fafff56bbed080/hypothesis-5.36.1.tar.gz
...
%prep
%setup -q -n hypothesis-5.36.1
cd %{_builddir}/hypothesis-5.36.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1601312883
...
cp %{_builddir}/hypothesis-5.36.1/LICENSE.txt %{buildroot}/usr/share/package-licenses/hypothesis/cbc4c246c44ed63fb158856a846c0962ae22668d
