...
Version  : 5.18.3
Release  : 418
URL      : https://files.pythonhosted.org/packages/30/aa/a3760a4e02475d528598d40bdd23f68df356a06bad96a99decdd81c578e1/hypothesis-5.18.3.tar.gz
Source0  : https://files.pythonhosted.org/packages/30/aa/a3760a4e02475d528598d40bdd23f68df356a06bad96a99decdd81c578e1/hypothesis-5.18.3.tar.gz
...
%prep
%setup -q -n hypothesis-5.18.3
cd %{_builddir}/hypothesis-5.18.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1593465913
...
cp %{_builddir}/hypothesis-5.18.3/LICENSE.txt %{buildroot}/usr/share/package-licenses/hypothesis/cbc4c246c44ed63fb158856a846c0962ae22668d
