...
Version  : 6.30.1
Release  : 568
URL      : https://files.pythonhosted.org/packages/61/7e/d87231123cddeca5b31578c4d0b36613162513e7edd96ef6b4ead5d5ceec/hypothesis-6.30.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/61/7e/d87231123cddeca5b31578c4d0b36613162513e7edd96ef6b4ead5d5ceec/hypothesis-6.30.1.tar.gz
...
%prep
%setup -q -n hypothesis-6.30.1
cd %{_builddir}/hypothesis-6.30.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1638825413
...
cp %{_builddir}/hypothesis-6.30.1/LICENSE.txt %{buildroot}/usr/share/package-licenses/hypothesis/cbc4c246c44ed63fb158856a846c0962ae22668d
