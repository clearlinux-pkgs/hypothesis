...
Version  : 5.7.1
Release  : 396
URL      : https://files.pythonhosted.org/packages/d3/ae/3f614241122f41e4d947bbfb71de4f0de19b4927b67c61673807f5baed5d/hypothesis-5.7.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/d3/ae/3f614241122f41e4d947bbfb71de4f0de19b4927b67c61673807f5baed5d/hypothesis-5.7.1.tar.gz
...
%prep
%setup -q -n hypothesis-5.7.1
cd %{_builddir}/hypothesis-5.7.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1584997751
...
cp %{_builddir}/hypothesis-5.7.1/LICENSE.txt %{buildroot}/usr/share/package-licenses/hypothesis/cbc4c246c44ed63fb158856a846c0962ae22668d
