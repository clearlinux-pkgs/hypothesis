...
Source0  : https://files.pythonhosted.org/packages/8e/39/2a08825dd0b7501cbed469aca9580d9b68df4ae72d0089f445d2ffd775c7/hypothesis-6.12.0.tar.gz
...
%prep
%setup -q -n hypothesis-6.12.0
cd %{_builddir}/hypothesis-6.12.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1620311520
...
cp %{_builddir}/hypothesis-6.12.0/LICENSE.txt %{buildroot}/usr/share/package-licenses/hypothesis/cbc4c246c44ed63fb158856a846c0962ae22668d
