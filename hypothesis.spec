...
Version  : 6.10.1
Release  : 506
URL      : https://files.pythonhosted.org/packages/7b/6e/6cf7f79a2337679e7edc4ad842eb726a56123fda1d8aed9bf07f0cbd5c13/hypothesis-6.10.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/7b/6e/6cf7f79a2337679e7edc4ad842eb726a56123fda1d8aed9bf07f0cbd5c13/hypothesis-6.10.1.tar.gz
...
%prep
%setup -q -n hypothesis-6.10.1
cd %{_builddir}/hypothesis-6.10.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1619447289
...
cp %{_builddir}/hypothesis-6.10.1/LICENSE.txt %{buildroot}/usr/share/package-licenses/hypothesis/cbc4c246c44ed63fb158856a846c0962ae22668d
