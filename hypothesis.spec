...
Source0  : https://files.pythonhosted.org/packages/37/07/eb38c67ba359b306dfbc5d680ee267f343c6b705980444754465c9cb4b3a/hypothesis-6.0.4.tar.gz
...
%prep
%setup -q -n hypothesis-6.0.4
cd %{_builddir}/hypothesis-6.0.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1611799983
...
cp %{_builddir}/hypothesis-6.0.4/LICENSE.txt %{buildroot}/usr/share/package-licenses/hypothesis/cbc4c246c44ed63fb158856a846c0962ae22668d
