...
Version  : 6.0.2
Release  : 478
URL      : https://files.pythonhosted.org/packages/a2/b5/99a089f8598f70c771c92b998cfb7328f5e186bc928fa09ed6acca389016/hypothesis-6.0.2.tar.gz
Source0  : https://files.pythonhosted.org/packages/a2/b5/99a089f8598f70c771c92b998cfb7328f5e186bc928fa09ed6acca389016/hypothesis-6.0.2.tar.gz
...
%prep
%setup -q -n hypothesis-6.0.2
cd %{_builddir}/hypothesis-6.0.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1610672018
...
cp %{_builddir}/hypothesis-6.0.2/LICENSE.txt %{buildroot}/usr/share/package-licenses/hypothesis/cbc4c246c44ed63fb158856a846c0962ae22668d
