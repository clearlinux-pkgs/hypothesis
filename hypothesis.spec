...
Version  : 3.9.0
Release  : 30
URL      : http://pypi.debian.net/hypothesis/hypothesis-3.9.0.tar.gz
Source0  : http://pypi.debian.net/hypothesis/hypothesis-3.9.0.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1495314116
