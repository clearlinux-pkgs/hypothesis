...
Version  : 4.47.2
Release  : 364
URL      : https://files.pythonhosted.org/packages/38/f8/b73150d55be07c16f8b7e3414489f59266e3cc2be8979ff44622b6ebaedb/hypothesis-4.47.2.tar.gz
Source0  : https://files.pythonhosted.org/packages/38/f8/b73150d55be07c16f8b7e3414489f59266e3cc2be8979ff44622b6ebaedb/hypothesis-4.47.2.tar.gz
...
%prep
%setup -q -n hypothesis-4.47.2
cd %{_builddir}/hypothesis-4.47.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1574712928
...
cp %{_builddir}/hypothesis-4.47.2/LICENSE.txt %{buildroot}/usr/share/package-licenses/hypothesis/cbc4c246c44ed63fb158856a846c0962ae22668d
