...
Source0  : https://files.pythonhosted.org/packages/97/56/3bf2751661ce17b7e917ed1c5ffeada93ed00c67e3edba7f8d41b6a48756/hypothesis-6.14.3.tar.gz
...
%prep
%setup -q -n hypothesis-6.14.3
cd %{_builddir}/hypothesis-6.14.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1626722667
...
cp %{_builddir}/hypothesis-6.14.3/LICENSE.txt %{buildroot}/usr/share/package-licenses/hypothesis/cbc4c246c44ed63fb158856a846c0962ae22668d
