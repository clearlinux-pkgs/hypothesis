...
Version  : 4.55.2
Release  : 373
URL      : https://files.pythonhosted.org/packages/2d/cc/62316aed4da584f60eeec8649f28ee03524fc7d44dce0bd358eca0b82916/hypothesis-4.55.2.tar.gz
Source0  : https://files.pythonhosted.org/packages/2d/cc/62316aed4da584f60eeec8649f28ee03524fc7d44dce0bd358eca0b82916/hypothesis-4.55.2.tar.gz
...
%prep
%setup -q -n hypothesis-4.55.2
cd %{_builddir}/hypothesis-4.55.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1576597167
...
cp %{_builddir}/hypothesis-4.55.2/LICENSE.txt %{buildroot}/usr/share/package-licenses/hypothesis/cbc4c246c44ed63fb158856a846c0962ae22668d
