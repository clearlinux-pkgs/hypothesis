...
Version  : 6.32.1
Release  : 572
URL      : https://files.pythonhosted.org/packages/9f/0d/545586f90a2cd5ca713c47d2c40232b4e0e6f04bbfb2104b39b8f67d1095/hypothesis-6.32.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/9f/0d/545586f90a2cd5ca713c47d2c40232b4e0e6f04bbfb2104b39b8f67d1095/hypothesis-6.32.1.tar.gz
...
%prep
%setup -q -n hypothesis-6.32.1
cd %{_builddir}/hypothesis-6.32.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1640274346
...
cp %{_builddir}/hypothesis-6.32.1/LICENSE.txt %{buildroot}/usr/share/package-licenses/hypothesis/cbc4c246c44ed63fb158856a846c0962ae22668d
