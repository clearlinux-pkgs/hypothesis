...
Source0  : https://files.pythonhosted.org/packages/bc/bb/4189ed9e355b13f1a268807a57a570b5d8723537c959d1a86c8b320cf7bf/hypothesis-6.21.6.tar.gz
...
%prep
%setup -q -n hypothesis-6.21.6
cd %{_builddir}/hypothesis-6.21.6
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1632179652
...
cp %{_builddir}/hypothesis-6.21.6/LICENSE.txt %{buildroot}/usr/share/package-licenses/hypothesis/cbc4c246c44ed63fb158856a846c0962ae22668d
