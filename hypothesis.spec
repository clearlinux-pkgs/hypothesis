...
Version  : 6.3.3
Release  : 488
URL      : https://files.pythonhosted.org/packages/6e/5b/e8bcf4e9a2acc9d77686de6e7b11d145090cf9bb5790497c8e0862128705/hypothesis-6.3.3.tar.gz
Source0  : https://files.pythonhosted.org/packages/6e/5b/e8bcf4e9a2acc9d77686de6e7b11d145090cf9bb5790497c8e0862128705/hypothesis-6.3.3.tar.gz
...
%prep
%setup -q -n hypothesis-6.3.3
cd %{_builddir}/hypothesis-6.3.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1614358406
...
cp %{_builddir}/hypothesis-6.3.3/LICENSE.txt %{buildroot}/usr/share/package-licenses/hypothesis/cbc4c246c44ed63fb158856a846c0962ae22668d
