...
Version  : 5.13.1
Release  : 407
URL      : https://files.pythonhosted.org/packages/da/fb/1b7b0c35158ddb86d618e2dc947e738153f7002448d2eaa7aaf45ef96c89/hypothesis-5.13.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/da/fb/1b7b0c35158ddb86d618e2dc947e738153f7002448d2eaa7aaf45ef96c89/hypothesis-5.13.1.tar.gz
...
%prep
%setup -q -n hypothesis-5.13.1
cd %{_builddir}/hypothesis-5.13.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1589337076
...
cp %{_builddir}/hypothesis-5.13.1/LICENSE.txt %{buildroot}/usr/share/package-licenses/hypothesis/cbc4c246c44ed63fb158856a846c0962ae22668d
