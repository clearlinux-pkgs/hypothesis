...
Version  : 6.4.0
Release  : 490
URL      : https://files.pythonhosted.org/packages/eb/40/6873785e9b4d46a3d3d1a192ddd51aaded0f1ce7ccfa773658499746c3dc/hypothesis-6.4.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/eb/40/6873785e9b4d46a3d3d1a192ddd51aaded0f1ce7ccfa773658499746c3dc/hypothesis-6.4.0.tar.gz
...
%prep
%setup -q -n hypothesis-6.4.0
cd %{_builddir}/hypothesis-6.4.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1614784384
...
cp %{_builddir}/hypothesis-6.4.0/LICENSE.txt %{buildroot}/usr/share/package-licenses/hypothesis/cbc4c246c44ed63fb158856a846c0962ae22668d
