...
Version  : 5.3.1
Release  : 384
URL      : https://files.pythonhosted.org/packages/46/91/a4dc6e1364acf36a6a5d3eea63a011ed872b8707233bbf6c58ae9330879c/hypothesis-5.3.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/46/91/a4dc6e1364acf36a6a5d3eea63a011ed872b8707233bbf6c58ae9330879c/hypothesis-5.3.1.tar.gz
...
%prep
%setup -q -n hypothesis-5.3.1
cd %{_builddir}/hypothesis-5.3.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1580139108
...
cp %{_builddir}/hypothesis-5.3.1/LICENSE.txt %{buildroot}/usr/share/package-licenses/hypothesis/cbc4c246c44ed63fb158856a846c0962ae22668d
