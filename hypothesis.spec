...
Version  : 6.17.0
Release  : 533
URL      : https://files.pythonhosted.org/packages/4c/17/67c010694e5ab0813005b356fff533b023f54ef7bf39679ae387cbb108ab/hypothesis-6.17.0.tar.gz
...
%prep
%setup -q -n hypothesis-6.17.0
cd %{_builddir}/hypothesis-6.17.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1630085942
...
cp %{_builddir}/hypothesis-6.17.0/LICENSE.txt %{buildroot}/usr/share/package-licenses/hypothesis/cbc4c246c44ed63fb158856a846c0962ae22668d
