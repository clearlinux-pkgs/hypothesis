...
Source0  : https://files.pythonhosted.org/packages/06/00/fc3f76d94c7366ef3d5a9c23326db82859fbf66ff96fdac975878f1888c7/hypothesis-6.13.5.tar.gz
...
%prep
%setup -q -n hypothesis-6.13.5
cd %{_builddir}/hypothesis-6.13.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1621865972
...
cp %{_builddir}/hypothesis-6.13.5/LICENSE.txt %{buildroot}/usr/share/package-licenses/hypothesis/cbc4c246c44ed63fb158856a846c0962ae22668d
