...
%prep
%setup -q -n hypothesis-4.56.3
cd %{_builddir}/hypothesis-4.56.3
...
cp %{_builddir}/hypothesis-4.56.3/LICENSE.txt %{buildroot}/usr/share/package-licenses/hypothesis/cbc4c246c44ed63fb158856a846c0962ae22668d
