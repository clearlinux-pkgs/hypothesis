...
Version  : 6.27.0
Release  : 563
URL      : https://files.pythonhosted.org/packages/a3/46/e0f0ba38f93929f3d48cda454484be0a6b36171ff076ebab448158030063/hypothesis-6.27.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/a3/46/e0f0ba38f93929f3d48cda454484be0a6b36171ff076ebab448158030063/hypothesis-6.27.0.tar.gz
...
%prep
%setup -q -n hypothesis-6.27.0
cd %{_builddir}/hypothesis-6.27.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1637600224
...
cp %{_builddir}/hypothesis-6.27.0/LICENSE.txt %{buildroot}/usr/share/package-licenses/hypothesis/cbc4c246c44ed63fb158856a846c0962ae22668d
