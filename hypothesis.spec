...
Version  : 6.1.0
Release  : 481
URL      : https://files.pythonhosted.org/packages/8c/b3/ff3668643626bc4b74af156b74b9f43603b52fd93fc2e89042127457a7aa/hypothesis-6.1.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/8c/b3/ff3668643626bc4b74af156b74b9f43603b52fd93fc2e89042127457a7aa/hypothesis-6.1.0.tar.gz
...
%prep
%setup -q -n hypothesis-6.1.0
cd %{_builddir}/hypothesis-6.1.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1611929521
...
cp %{_builddir}/hypothesis-6.1.0/LICENSE.txt %{buildroot}/usr/share/package-licenses/hypothesis/cbc4c246c44ed63fb158856a846c0962ae22668d
