...
Source0  : https://files.pythonhosted.org/packages/c1/2b/ab089c7d6f4b8e4b8a97d946b1295311ec9b9442d25522cbe9c81418b41f/hypothesis-6.1.1.tar.gz
...
%prep
%setup -q -n hypothesis-6.1.1
cd %{_builddir}/hypothesis-6.1.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1612193124
...
cp %{_builddir}/hypothesis-6.1.1/LICENSE.txt %{buildroot}/usr/share/package-licenses/hypothesis/cbc4c246c44ed63fb158856a846c0962ae22668d
