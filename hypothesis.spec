...
Version  : 4.45.1
Release  : 361
URL      : https://files.pythonhosted.org/packages/d1/b6/0bc424e400dde7e283df77523226d88bd7910daedd0ae38527ff725e601c/hypothesis-4.45.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/d1/b6/0bc424e400dde7e283df77523226d88bd7910daedd0ae38527ff725e601c/hypothesis-4.45.1.tar.gz
...
%prep
%setup -q -n hypothesis-4.45.1
cd %{_builddir}/hypothesis-4.45.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1574347755
...
cp %{_builddir}/hypothesis-4.45.1/LICENSE.txt %{buildroot}/usr/share/package-licenses/hypothesis/cbc4c246c44ed63fb158856a846c0962ae22668d
