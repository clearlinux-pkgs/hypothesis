...
Version  : 5.5.1
Release  : 389
URL      : https://files.pythonhosted.org/packages/e3/72/c135abdc531ac5f628a60891921d12cd937e87616fd6da4bb0629cb3e159/hypothesis-5.5.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/e3/72/c135abdc531ac5f628a60891921d12cd937e87616fd6da4bb0629cb3e159/hypothesis-5.5.1.tar.gz
...
%prep
%setup -q -n hypothesis-5.5.1
cd %{_builddir}/hypothesis-5.5.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1581086977
...
cp %{_builddir}/hypothesis-5.5.1/LICENSE.txt %{buildroot}/usr/share/package-licenses/hypothesis/cbc4c246c44ed63fb158856a846c0962ae22668d
