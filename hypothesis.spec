...
Source0  : https://files.pythonhosted.org/packages/3e/fa/aef438947b3de7e8140e252bea2d852767ce830daf4515a48e7eee35db1b/hypothesis-6.23.1.tar.gz
...
%prep
%setup -q -n hypothesis-6.23.1
cd %{_builddir}/hypothesis-6.23.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1632947513
...
cp %{_builddir}/hypothesis-6.23.1/LICENSE.txt %{buildroot}/usr/share/package-licenses/hypothesis/cbc4c246c44ed63fb158856a846c0962ae22668d
