...
%prep
%setup -q -n hypothesis-6.31.4
cd %{_builddir}/hypothesis-6.31.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1639415699
...
cp %{_builddir}/hypothesis-6.31.4/LICENSE.txt %{buildroot}/usr/share/package-licenses/hypothesis/cbc4c246c44ed63fb158856a846c0962ae22668d
