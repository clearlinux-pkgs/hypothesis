...
Source0  : https://files.pythonhosted.org/packages/72/01/0f12f7992240f9d676bf8f31aa7ac898325c34d455c876a726329d548f65/hypothesis-5.5.4.tar.gz
...
%prep
%setup -q -n hypothesis-5.5.4
cd %{_builddir}/hypothesis-5.5.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1582936633
...
cp %{_builddir}/hypothesis-5.5.4/LICENSE.txt %{buildroot}/usr/share/package-licenses/hypothesis/cbc4c246c44ed63fb158856a846c0962ae22668d
