...
Version  : 6.15.0
Release  : 532
URL      : https://files.pythonhosted.org/packages/4a/57/842af597a966f65a0dc745d6ed48d449e092d68f09f33ca8f338ad023be0/hypothesis-6.15.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/4a/57/842af597a966f65a0dc745d6ed48d449e092d68f09f33ca8f338ad023be0/hypothesis-6.15.0.tar.gz
...
%prep
%setup -q -n hypothesis-6.15.0
cd %{_builddir}/hypothesis-6.15.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1629736230
...
cp %{_builddir}/hypothesis-6.15.0/LICENSE.txt %{buildroot}/usr/share/package-licenses/hypothesis/cbc4c246c44ed63fb158856a846c0962ae22668d
