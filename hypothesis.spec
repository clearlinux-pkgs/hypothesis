...
Source0  : https://files.pythonhosted.org/packages/3d/29/2cefde2a4b064c8eaf9e6642e8d49b297f74a12273ef6794fe47f9fae584/hypothesis-6.17.4.tar.gz
...
%prep
%setup -q -n hypothesis-6.17.4
cd %{_builddir}/hypothesis-6.17.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1630452569
...
cp %{_builddir}/hypothesis-6.17.4/LICENSE.txt %{buildroot}/usr/share/package-licenses/hypothesis/cbc4c246c44ed63fb158856a846c0962ae22668d
