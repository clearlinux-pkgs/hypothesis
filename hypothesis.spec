...
Version  : 5.37.1
Release  : 454
URL      : https://files.pythonhosted.org/packages/a9/e5/6f40d947ae8337573bc9e9759a697960896a5c6c1f0f7d8bb6432cca68cb/hypothesis-5.37.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/a9/e5/6f40d947ae8337573bc9e9759a697960896a5c6c1f0f7d8bb6432cca68cb/hypothesis-5.37.1.tar.gz
...
%prep
%setup -q -n hypothesis-5.37.1
cd %{_builddir}/hypothesis-5.37.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1602171248
...
cp %{_builddir}/hypothesis-5.37.1/LICENSE.txt %{buildroot}/usr/share/package-licenses/hypothesis/cbc4c246c44ed63fb158856a846c0962ae22668d
