...
Version  : 6.14.7
Release  : 529
URL      : https://files.pythonhosted.org/packages/a1/a1/fb64be296cc12274acc1c71d17979361f34eda500016d75969c296803279/hypothesis-6.14.7.tar.gz
Source0  : https://files.pythonhosted.org/packages/a1/a1/fb64be296cc12274acc1c71d17979361f34eda500016d75969c296803279/hypothesis-6.14.7.tar.gz
...
%prep
%setup -q -n hypothesis-6.14.7
cd %{_builddir}/hypothesis-6.14.7
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1629128471
...
cp %{_builddir}/hypothesis-6.14.7/LICENSE.txt %{buildroot}/usr/share/package-licenses/hypothesis/cbc4c246c44ed63fb158856a846c0962ae22668d
