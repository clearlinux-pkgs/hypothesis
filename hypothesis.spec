...
Version  : 6.8.4
Release  : 498
URL      : https://files.pythonhosted.org/packages/be/80/eefa127874edc9d9edeb3420664f5abb612b76a02f94e6a7e1108f898afd/hypothesis-6.8.4.tar.gz
Source0  : https://files.pythonhosted.org/packages/be/80/eefa127874edc9d9edeb3420664f5abb612b76a02f94e6a7e1108f898afd/hypothesis-6.8.4.tar.gz
...
%prep
%setup -q -n hypothesis-6.8.4
cd %{_builddir}/hypothesis-6.8.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1617304611
...
cp %{_builddir}/hypothesis-6.8.4/LICENSE.txt %{buildroot}/usr/share/package-licenses/hypothesis/cbc4c246c44ed63fb158856a846c0962ae22668d
