...
Version  : 3.7.0
Release  : 21
URL      : http://pypi.debian.net/hypothesis/hypothesis-3.7.0.tar.gz
Source0  : http://pypi.debian.net/hypothesis/hypothesis-3.7.0.tar.gz
...
%prep
%setup -q -n hypothesis-3.7.0

%build
export LANG=C
export SOURCE_DATE_EPOCH=1490795778
