...
Source0  : https://files.pythonhosted.org/packages/da/be/b0ab4290699b2e05aae642e5e851a2c46f8bb44a4e9cf094cc8fddd14709/hypothesis-6.25.0.tar.gz
...
%prep
%setup -q -n hypothesis-6.25.0
cd %{_builddir}/hypothesis-6.25.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1637366845
...
cp %{_builddir}/hypothesis-6.25.0/LICENSE.txt %{buildroot}/usr/share/package-licenses/hypothesis/cbc4c246c44ed63fb158856a846c0962ae22668d
