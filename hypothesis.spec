...
%prep
%setup -q -n hypothesis-6.24.0
cd %{_builddir}/hypothesis-6.24.0
...
cp %{_builddir}/hypothesis-6.24.0/LICENSE.txt %{buildroot}/usr/share/package-licenses/hypothesis/cbc4c246c44ed63fb158856a846c0962ae22668d
