...
Source0  : https://files.pythonhosted.org/packages/27/eb/d5623fba156d72d67a945f4d515f5e31d6e23ede343fed2e3dabc3577a71/hypothesis-5.41.1.tar.gz
...
%prep
%setup -q -n hypothesis-5.41.1
cd %{_builddir}/hypothesis-5.41.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1604509001
...
cp %{_builddir}/hypothesis-5.41.1/LICENSE.txt %{buildroot}/usr/share/package-licenses/hypothesis/cbc4c246c44ed63fb158856a846c0962ae22668d
