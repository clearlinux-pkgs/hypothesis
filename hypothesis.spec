...
Version  : 3.7.4
Release  : 24
URL      : http://pypi.debian.net/hypothesis/hypothesis-3.7.4.tar.gz
Source0  : http://pypi.debian.net/hypothesis/hypothesis-3.7.4.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1492959365
